...
extern void gic_add_to_lr_pending(struct vcpu *v, struct pending_irq *n);
...
struct gic_hw_operations {
    ...
    void (*fetch_lrs) (struct vcpu *v, uint64_t *mask);
    void (*push_lrs) (struct vcpu *v, uint64_t *mask);
};
